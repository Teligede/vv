...
cd /usr/bin
wget https://raw.githubusercontent.com/Teligede/vv/main/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
cd /root
wget https://raw.githubusercontent.com/Teligede/vv/main/regis.zip
unzip regis.zip
rm -rf regis.zip
...
echo -e "${grenbo}[*] Bot By RMBL VPN PROJECT${NC}"
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
[Unit]
Description=Simple register - @RMBL STORE
